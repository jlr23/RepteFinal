...
const startFight = async (pers1, pers2) => {
    ...
    let aux = battle.value + ""
    router.push({ name: 'fight', params: { listCharacters: aux } })
}
...
<template>
    <div class="characters">
        ...
        <div v-if="battle.length > 0 && battle.length < 3" class="battle">
            <div v-if="battle[0]" class=" player" :class="{ 'player1': startAnimation }">
